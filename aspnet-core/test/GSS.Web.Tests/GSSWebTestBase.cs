...
{
    public abstract class GSSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GSSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GSSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GSSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GSSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GSSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GSSDbContext, Task<T>> func)
        {
            T result;
